...
(function(exports) {
  ...
  var $dot$dot$dot = function (inf) {
      return function (sup) {
          ...
          throw new Error("Failed pattern match at Util line 103, column 1 - line 104, column 1: " + [ inf.constructor.name, sup.constructor.name ]);
      };
  };
  ...
  var scramble = function (_32) {
      return rot13(Text_Browser_Base64.encode64(rot13(_32)));
  };
  var unscramble = function (_33) {
      return rot13(Text_Browser_Base64.decode64(rot13(_33)));
  };
  ...
  var schedule = function (arr) {
      ...
      var goElt = function (_5) {
          ...
          throw new Error("Failed pattern match at Util line 64, column 1 - line 65, column 1: " + [ _19.constructor.name ]);
      };
...
(function(exports) {
  ...
  var sumUpgrade = function (_8) {
      ...
      throw new Error("Failed pattern match at Upgrades line 168, column 1 - line 169, column 1: " + [ _8.constructor.name ]);
  };
  ...
  var buyUpgrade = function (_7) {
      ...
      throw new Error("Failed pattern match at Upgrades line 116, column 1 - line 117, column 1: " + [ _7.constructor.name ]);
  };

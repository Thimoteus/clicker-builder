...
(function(exports) {
  ...
  var $dot$dot$dot = function (inf) {
      return function (sup) {
          ...
          throw new Error("Failed pattern match at Util line 106, column 1 - line 107, column 1: " + [ inf.constructor.name, sup.constructor.name ]);
      };
  };
  ...
  var rot13 = (function () {
      var rotate = function (c) {
          ...
          throw new Error("Failed pattern match at Util line 38, column 5 - line 39, column 5: " + [ c.constructor.name ]);
      };
      return function (_31) {
          return Data_String.fromCharArray(Prelude.map(Prelude.functorArray)(rotate)(Data_String.toCharArray(_31)));
      };
  })();
  var scramble = function (_32) {
      return rot13(Text_Base64.encode64(rot13(_32)));
  };
  var unscramble = function (_33) {
      return rot13(Text_Base64.decode64(rot13(_33)));
  };
  var renderText = function (_34) {
      return Halogen_HTML_Elements.div_(Prelude.map(Prelude.functorArray)(function (_35) {
          return Halogen_HTML_Elements.p_(Prelude.pure(Prelude.applicativeArray)(Halogen_HTML.text(_35)));
      })(_34));
  };
  ...
  var foldGCD = function (__dict_Foldable_0) {
      var foldGCD$prime = function (_6) {
          return function (y) {
              ...
              throw new Error("Failed pattern match at Util line 91, column 5 - line 92, column 5: " + [ _6.constructor.name, y.constructor.name ]);
          };
      };
      ...
      var goElt = function (_5) {
          ...
          if (!_19) {
              return Prelude.pure(Control_Monad_Aff.applicativeAff)((function () {
                  var _22 = {};
                  for (var _23 in _5) {
                      if (_5.hasOwnProperty(_23)) {
                          _22[_23] = _5[_23];
                      };
                  };
                  _22.numbalert = _5.numbalert + theGCD | 0;
                  return _22;
              })());
          };
          throw new Error("Failed pattern match at Util line 67, column 1 - line 68, column 1: " + [ _19.constructor.name ]);
      };
...
(function(exports) {
  ...
  var semiringClicksPerSecond = new Prelude.Semiring(function (_24) {
      return function (_25) {
          return _24 + _25;
      };
  }, function (_22) {
  ...
  exports["semiringClicksPerSecond"] = semiringClicksPerSecond;
...
(function(exports) {
  ...
  var upgradeName = function (_1) {
      return function (_2) {
          ...
          throw new Error("Failed pattern match at Upgrades line 47, column 1 - line 48, column 1: " + [ _1.constructor.name, _2.constructor.name ]);
      };
  };
  var upgradeDescription = function (_3) {
      return function (_4) {
          ...
          throw new Error("Failed pattern match at Upgrades line 59, column 1 - line 60, column 1: " + [ _3.constructor.name, _4.constructor.name ]);
      };
  };
  var upgradeCostModifier = function (n) {
      ...
      throw new Error("Failed pattern match at Upgrades line 38, column 1 - line 39, column 1: " + [ n.constructor.name ]);
  };
  ...
  var upgradeCost = function (_0) {
      ...
      throw new Error("Failed pattern match at Upgrades line 23, column 1 - line 24, column 1: " + [ _0.constructor.name ]);
  };
  var upgradeBoostModifier = function (n) {
      ...
      throw new Error("Failed pattern match at Upgrades line 103, column 1 - line 104, column 1: " + [ n.constructor.name ]);
  };
  var upgradeBoost = function (_6) {
      ...
      if (_6 instanceof Types.Burst1) {
          return 0.75 * upgradeBoostModifier(_6.value0);
      };
      ...
      throw new Error("Failed pattern match at Upgrades line 91, column 1 - line 92, column 1: " + [ _6.constructor.name ]);
  };
  var recordPurchase = function (up) {
      return function (optic) {
          return function (_164) {
              return Data_Lens_Setter["-~"](Types.ringClicks)(Lenses.currentClicks(Data_Profunctor_Strong.strongFn))(upgradeCost(up))(Data_Lens_Setter[".~"](function (_165) {
                  return Lenses.upgrades(Data_Profunctor_Strong.strongFn)(optic(Data_Profunctor_Strong.strongFn)(_165));
              })(up)(_164));
          };
      };
  };
  var nextUpgrade = function (_5) {
      ...
      throw new Error("Failed pattern match at Upgrades line 71, column 1 - line 72, column 1: " + [ _5.constructor.name ]);
  };
  var makeCPS5 = function (n) {
      return new Types.CPS5(n, Types.tagCPS5);
  };
  var makeCPS4 = function (n) {
      return new Types.CPS4(n, Types.tagCPS4);
  };
  var makeCPS3 = function (n) {
      return new Types.CPS3(n, Types.tagCPS3);
  };
  var makeCPS2 = function (n) {
      return new Types.CPS2(n, Types.tagCPS2);
  };
  var makeCPS1 = function (n) {
      return new Types.CPS1(n, Types.tagCPS1);
  };
  var makeBurst5 = function (n) {
      return new Types.Burst5(n, Types.tagBurst5);
  };
  var makeBurst4 = function (n) {
      return new Types.Burst4(n, Types.tagBurst4);
  };
  var makeBurst3 = function (n) {
      return new Types.Burst3(n, Types.tagBurst3);
  };
  var makeBurst2 = function (n) {
      return new Types.Burst2(n, Types.tagBurst2);
  };
  var makeBurst1 = function (n) {
      return new Types.Burst1(n, Types.tagBurst1);
  };
  var sumUpgrade = function (_8) {
      if (_8 instanceof Types.CPS1) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(function (_166) {
              return upgradeBoost(makeCPS1(_166));
          })(Util["..."](1)(_8.value0)));
      };
      if (_8 instanceof Types.CPS2) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(function (_167) {
              return upgradeBoost(makeCPS2(_167));
          })(Util["..."](1)(_8.value0)));
      };
      if (_8 instanceof Types.CPS3) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(function (_168) {
              return upgradeBoost(makeCPS3(_168));
          })(Util["..."](1)(_8.value0)));
      };
      if (_8 instanceof Types.CPS4) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(function (_169) {
              return upgradeBoost(makeCPS4(_169));
          })(Util["..."](1)(_8.value0)));
      };
      if (_8 instanceof Types.CPS5) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(function (_170) {
              return upgradeBoost(makeCPS5(_170));
          })(Util["..."](1)(_8.value0)));
      };
      if (_8 instanceof Types.Burst1) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(function (_171) {
              return upgradeBoost(makeBurst1(_171));
          })(Util["..."](1)(_8.value0)));
      };
      if (_8 instanceof Types.Burst2) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(function (_172) {
              return upgradeBoost(makeBurst2(_172));
          })(Util["..."](1)(_8.value0)));
      };
      if (_8 instanceof Types.Burst3) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(function (_173) {
              return upgradeBoost(makeBurst3(_173));
          })(Util["..."](1)(_8.value0)));
      };
      if (_8 instanceof Types.Burst4) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(function (_174) {
              return upgradeBoost(makeBurst4(_174));
          })(Util["..."](1)(_8.value0)));
      };
      if (_8 instanceof Types.Burst5) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(function (_175) {
              return upgradeBoost(makeBurst5(_175));
          })(Util["..."](1)(_8.value0)));
      };
      throw new Error("Failed pattern match at Upgrades line 167, column 1 - line 168, column 1: " + [ _8.constructor.name ]);
  };
  ...
  var cpsFromUpgrades = function (_10) {
      var upgradeArray = [ _10.cps1, _10.cps2, _10.cps3, _10.cps4, _10.cps5 ];
      return Prelude["+"](Types.semiringClicksPerSecond)(Data_Lens_Getter["^."](Types.initialState)(Lenses.cps(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))(Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(sumUpgrade)(upgradeArray)));
  };
  var canBuyUpgrade = function (state) {
      return function (optic) {
          var currUpgrade = Data_Lens_Getter["^."](state)(function (_176) {
              return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(optic(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(_176));
          });
  ...
  var buyUpgrade = function (_7) {
      ...
      throw new Error("Failed pattern match at Upgrades line 115, column 1 - line 116, column 1: " + [ _7.constructor.name ]);
  };
  var burstFromUpgrades = function (_9) {
      var upgradeArray = [ _9.burst1, _9.burst2, _9.burst3, _9.burst4, _9.burst5 ];
      return Prelude["+"](Types.semiringClicks)(Data_Lens_Getter["^."](Types.initialState)(Lenses.burst(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))(Data_Foldable.sum(Data_Foldable.foldableArray)(Prelude.semiringNumber)(Prelude.map(Prelude.functorArray)(sumUpgrade)(upgradeArray)));
  };
...
(function(exports) {
  ...
  var Data_Profunctor_Star = PS["Data.Profunctor.Star"];
  var Data_Const = PS["Data.Const"];     
  var welcomeMessage = "Welcome to clicker builder";
  var storageKeys = Prelude.map(Prelude.functorArray)(Util.scramble)([ "totalClicks", "currentClicks", "age", "upgrades" ]);
  ...
  var stateTuples = function (state) {
      var makeTuple = function (__dict_Serialize_0) {
          return function (key) {
              return function (_7) {
                  return Data_Bifunctor.bimap(Data_Tuple.bifunctorTuple)(Util.scramble)(function (_8) {
                      return Util.scramble(Types.serialize(__dict_Serialize_0)(_8));
                  })(Data_Tuple.Tuple.create(key)(_7));
              };
          };
      };
      return [ makeTuple(Types.serializeClicks)("currentClicks")(state.currentClicks), makeTuple(Types.serializeClicks)("totalClicks")(state.totalClicks), makeTuple(Types.serializeUpgrades)("upgrades")(state.upgrades), makeTuple(Types.serializeAge)("age")(state.age) ];
  };
  ...
  var saveState = function (_9) {
      return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(saveSingleState)(stateTuples(_9));
  };
      ...
      return function (_10) {
          return Data_Maybe.maybe(Types.initialState.upgrades)(Prelude.id(Prelude.categoryFn))(Data_Foreign_Lens.get(function (__dict_Contravariant_3) {
              return function (__dict_Applicative_4) {
                  return function (_11) {
                      return Data_Foreign_Lens.json(__dict_Contravariant_3)(__dict_Applicative_4)(ups(__dict_Contravariant_3)(__dict_Applicative_4)(_11));
                  };
              };
          })(Util.unscramble(_10)));
      };
      ...
      return function (_13) {
          return Data_Maybe.maybe($$default)(Prelude.id(Prelude.categoryFn))(Data_Foreign_Lens.get(function (__dict_Contravariant_7) {
              return function (__dict_Applicative_8) {
                  return function (_14) {
                      return Data_Foreign_Lens.json(__dict_Contravariant_7)(__dict_Applicative_8)(Data_Foreign_Lens.number(__dict_Contravariant_7)(__dict_Applicative_8)(_14));
                  };
              };
          })(Util.unscramble(_13)));
      };
  };
  var parseCurrentClicks = function (_15) {
      return Types.Clicks(getNumber(Data_Lens_Getter["^."](Types.initialState)(Lenses.currentClicksNumber(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))(_15));
  };
  var parseTotalClicks = function (_16) {
      return Types.Clicks(getNumber(Data_Lens_Getter["^."](Types.initialState)(Lenses.totalClicksNumber(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))(_16));
  };
  var getSavedState = function __do() {
      var _3 = Prelude["<$>"](Control_Monad_Eff.functorEff)(function (_17) {
          return Data_Array.zip(storageKeys)(Data_Array.catMaybes(_17));
      ...
      return (function () {
          var _upgrades = stateValueMaker(Data_Lens_Getter.view(Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))(parseUpgrades)("upgrades")(_3);
          var _totalClicks = stateValueMaker(function (_1) {
              return _1.totalClicks;
          })(parseTotalClicks)("totalClicks")(_3);
          var _currentClicks = stateValueMaker(function (_0) {
              return _0.currentClicks;
          })(parseCurrentClicks)("currentClicks")(_3);
          var _age = stateValueMaker(function (_2) {
              return _2.age;
          })(parseAge)("age")(_3);
          return Prelude.pure(Control_Monad_Eff.applicativeEff)({
              currentClicks: _currentClicks, 
              totalClicks: _totalClicks, 
              upgrades: _upgrades, 
              age: _age, 
              message: welcomeMessage, 
              cps: Upgrades.cpsFromUpgrades(_upgrades), 
              burst: Upgrades.burstFromUpgrades(_upgrades)
          });
      })()();
  };
...
(function(exports) {
  ...
  var upgradeProps = function (cpsn) {
      return function (state) {
          ...
          return Prelude["++"](Prelude.semigroupArray)(hoverText(state)(cpsn(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))((function () {
              ...
              throw new Error("Failed pattern match at Main line 143, column 1 - line 144, column 1: " + [ _4.constructor.name ]);
          })());
      };
  };
  ...
  var upgradesComponent = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.class_(Halogen_HTML_Core.className("upgrades cps")) ])([ Halogen_HTML_Elements_Indexed.span([ Halogen_HTML_Properties_Indexed.class_(Halogen_HTML_Core.className("category")) ])([ Halogen_HTML.text("Tribal upgrades") ]), upgradeButton(function (__dict_Strong_2) {
      ...
      })(state) ]), Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.class_(Halogen_HTML_Core.className("upgrades burst")) ])([ Halogen_HTML_Elements_Indexed.span([ Halogen_HTML_Properties_Indexed.class_(Halogen_HTML_Core.className("category")) ])([ Halogen_HTML.text("Self upgrades") ]), upgradeButton(function (__dict_Strong_7) {
  ...
  var $$eval = function (_3) {
              ...
              return Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query["liftAff'"](Control_Monad_Aff_Class.monadAffAff)(Control_Monad_Aff.later(Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.unit))))(function () {
                  return Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(Upgrades.buyUpgrade(_3.value0)))(function () {
                      return Prelude.bind(Control_Monad_Free.freeBind)((function () {
                          ...
                          if (!_12) {
                              return Halogen_Query.modify(function (state) {
                                  return Data_Lens_Setter.set(Lenses.message(Data_Profunctor_Strong.strongFn))("Upgraded " + Upgrades.upgradeName(_3.value0)(state.age))(state);
                              });
                          };
                          throw new Error("Failed pattern match at Main line 154, column 1 - line 155, column 1: " + [ _12.constructor.name ]);
                      })())(function () {
      ...
      throw new Error("Failed pattern match at Main line 154, column 1 - line 155, column 1: " + [ _3.constructor.name ]);
  };

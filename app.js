...
(function(exports) {
  ...
  var serializeUpgrade = new Serialize(function (_35) {
      ...
      throw new Error("Failed pattern match at Types line 266, column 1 - line 278, column 1: " + [ _35.constructor.name ]);
  });
  ...
  var prettyNumber = new Pretty(function (n) {
      ...
      throw new Error("Failed pattern match at Types line 221, column 1 - line 233, column 1: " + [ n.constructor.name ]);
  });                                                       
  ...
  var genericAge = new Data_Generic.Generic(function ($dollarx) {
      ...
      throw new Error("Failed pattern match at Types line 201, column 1 - line 203, column 1: " + [ $dollarx.constructor.name ]);
  });
...
(function(exports) {
  ...
  var viewLevel = (function () {
      var viewLevel$prime = function (_43) {
          if (_43 instanceof Types.CPS1) {
              return _43.value0;
          };
          if (_43 instanceof Types.CPS2) {
              return _43.value0;
          };
          if (_43 instanceof Types.CPS3) {
              return _43.value0;
          };
          if (_43 instanceof Types.CPS4) {
              return _43.value0;
          };
          if (_43 instanceof Types.CPS5) {
              return _43.value0;
          };
          if (_43 instanceof Types.Burst1) {
              return _43.value0;
          };
          if (_43 instanceof Types.Burst2) {
              return _43.value0;
          };
          if (_43 instanceof Types.Burst3) {
              return _43.value0;
          };
          if (_43 instanceof Types.Burst4) {
              return _43.value0;
          };
          if (_43 instanceof Types.Burst5) {
              return _43.value0;
          };
          throw new Error("Failed pattern match at Lenses line 78, column 5 - line 79, column 5: " + [ _43.constructor.name ]);
      };
  ...
  var currentClicks = function (__dict_Strong_2) {
      return Data_Lens_Lens.lens(function (_0) {
          ...
          return function (_2) {
              var _70 = {};
              for (var _71 in _1) {
                  if (_1.hasOwnProperty(_71)) {
                      _70[_71] = _1[_71];
                  };
              };
              _70.currentClicks = _2;
              return _70;
          };
      })(__dict_Strong_2);
  };
  ...
  var cpsNumber = function (__dict_Strong_10) {
      return function (_117) {
          return cps(__dict_Strong_10)(clicksPerSecond(__dict_Strong_10)(_117));
      };
  };
  ...
  var currentClicksNumber = function (__dict_Strong_12) {
      return function (_118) {
          return currentClicks(__dict_Strong_12)(clicks(__dict_Strong_12)(_118));
      };
  };
  var totalClicksNumber = function (__dict_Strong_13) {
      return function (_119) {
          return totalClicks(__dict_Strong_13)(clicks(__dict_Strong_13)(_119));
      };
  };
  ...
  var burstNumber = function (__dict_Strong_20) {
      return function (_125) {
          return burst(__dict_Strong_20)(clicks(__dict_Strong_20)(_125));
      };
  };
...
(function(exports) {
  ...
  var upgradeName = function (_1) {
      return function (_2) {
          ...
          throw new Error("Failed pattern match at Upgrades line 41, column 1 - line 42, column 1: " + [ _1.constructor.name, _2.constructor.name ]);
      };
  };
  var upgradeDescription = function (_3) {
      return function (_4) {
          ...
          throw new Error("Failed pattern match at Upgrades line 53, column 1 - line 54, column 1: " + [ _3.constructor.name, _4.constructor.name ]);
      };
  };
  var upgradeCostModifier = function (n) {
      ...
      throw new Error("Failed pattern match at Upgrades line 33, column 1 - line 34, column 1: " + [ n.constructor.name ]);
  };
  ...
  var upgradeCost = function (_0) {
      ...
      throw new Error("Failed pattern match at Upgrades line 18, column 1 - line 19, column 1: " + [ _0.constructor.name ]);
  };
  var upgradeBoostModifier = function (n) {
      ...
      throw new Error("Failed pattern match at Upgrades line 97, column 1 - line 98, column 1: " + [ n.constructor.name ]);
  };
  var upgradeBoost = function (_6) {
      ...
      throw new Error("Failed pattern match at Upgrades line 85, column 1 - line 86, column 1: " + [ _6.constructor.name ]);
  };
  ...
  var nextUpgrade = function (_5) {
      ...
      throw new Error("Failed pattern match at Upgrades line 65, column 1 - line 66, column 1: " + [ _5.constructor.name ]);
  };
  ...
  var buyUpgrade = function (_7) {
      ...
      throw new Error("Failed pattern match at Upgrades line 105, column 1 - line 106, column 1: " + [ _7.constructor.name ]);
  };
...
(function(exports) {
      ...
      return function (state) {
          var hoverText = function (state_1) {
              return function (cpsn_1) {
                  return [ Halogen_HTML_Properties_Indexed.title(Upgrades.upgradeDescription(Data_Lens_Getter["^."](state_1)(function (_17) {
                      return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(cpsn_1(_17));
                  }))(state_1.age)) ];
              };
          };
          var clickAction = Halogen_HTML_Events_Indexed.onMouseDown(Halogen_HTML_Events.input_(Types.Buy.create(Upgrades.nextUpgrade(Data_Lens_Getter["^."](state)(function (_18) {
              return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(cpsn(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(_18));
          })))));
          return Prelude["++"](Prelude.semigroupArray)(hoverText(state)(cpsn(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))((function () {
              ...
              throw new Error("Failed pattern match at Main line 129, column 1 - line 130, column 1: " + [ _4.constructor.name ]);
          })());
      };
  };
  var upgradeButton = function (cpsn) {
      return function (state) {
          ...
          })(state))([ Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.class_(Halogen_HTML_Core.className("name")) ])([ Halogen_HTML.text(Upgrades.upgradeName(Data_Lens_Getter["^."](state)(function (_19) {
          ...
          }))(state.age)), Halogen_HTML_Elements_Indexed.span([ Halogen_HTML_Properties_Indexed.class_(Halogen_HTML_Core.className("level")) ])([ Halogen_HTML.text(" " + Prelude.show(Prelude.showInt)(Data_Lens_Getter["^."](state)(function (_20) {
              return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(cpsn(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel(_20)));
          }))) ]) ]), Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.class_(Halogen_HTML_Core.className("cost")) ])([ Halogen_HTML.text(Types.prettify(Types.prettyClicks)(Upgrades.upgradeCost(Upgrades.nextUpgrade(Data_Lens_Getter["^."](state)(function (_21) {
  ...
  var $$eval = function (_3) {
      ...
      throw new Error("Failed pattern match at Main line 140, column 1 - line 141, column 1: " + [ _3.constructor.name ]);
  };

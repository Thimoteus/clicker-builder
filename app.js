...
(function(exports) {
  ...
  var $dot$dot$dot = function (inf) {
      return function (sup) {
          ...
          throw new Error("Failed pattern match at Util line 109, column 1 - line 110, column 1: " + [ inf.constructor.name, sup.constructor.name ]);
      };
  };
  ...
  var foldGCD = function (__dict_Foldable_0) {
      var foldGCD$prime = function (_7) {
          return function (y) {
              ...
              throw new Error("Failed pattern match at Util line 94, column 5 - line 95, column 5: " + [ _7.constructor.name, y.constructor.name ]);
          };
      };
  ...
  var schedule = function (arr) {
      ...
      var goElt = function (_6) {
          ...
          throw new Error("Failed pattern match at Util line 70, column 1 - line 71, column 1: " + [ _21.constructor.name ]);
      };
...
(function(exports) {
  ...
  var prettyNumber = new Pretty(function (n) {
      ...
      if (Util.sigFigs(n) <= 12) {
          return Util.transformDigits(Data_Array.take(3))(n) + "b";
      };
      if (Util.sigFigs(n) <= 13) {
          return Util.transformDigits(Data_Array.take(4))(n) + "b";
      };
      if (Util.sigFigs(n) <= 14) {
          return Util.transformDigits(Data_Array.take(5))(n) + "b";
      };
      if (Util.sigFigs(n) <= 15) {
          return Util.transformDigits(Data_Array.take(3))(n) + "t";
      };
      if (Util.sigFigs(n) <= 16) {
          return Util.transformDigits(Data_Array.take(4))(n) + "t";
      };
      if (Util.sigFigs(n) <= 17) {
          return Util.transformDigits(Data_Array.take(5))(n) + "t";
      };
      if (Util.sigFigs(n) <= 18) {
          return Util.transformDigits(Data_Array.take(3))(n) + "q";
      };
      if (Util.sigFigs(n) <= 19) {
          return Util.transformDigits(Data_Array.take(4))(n) + "q";
      };
      if (Util.sigFigs(n) <= 20) {
          return Util.transformDigits(Data_Array.take(5))(n) + "q";
      };
      if (Util.sigFigs(n) <= 21) {
          return Util.transformDigits(Data_Array.take(3))(n) + "qi";
      };
      if (Util.sigFigs(n) <= 22) {
          return Util.transformDigits(Data_Array.take(4))(n) + "qi";
      };
      if (Util.sigFigs(n) <= 23) {
          return Util.transformDigits(Data_Array.take(5))(n) + "qi";
      };
      if (Prelude.otherwise) {
...
(function(exports) {
  ...
  var upgradeDescription = function (_3) {
      return function (_4) {
          ...
          if (_3 instanceof Types.Science2 && _4 instanceof Types.Stone) {
              return "You've discovered that two clicks and two dogs both share 'twoness.' You also almost discovered the ultrafilter lemma, but you couldn't write it down fast enough.";
          };
  ...
  var upgradeCost = function (_0) {
      ...
      if (_0 instanceof Types.Tech2) {
          return upgradeCostPolynomial(95000.0)(_0.value0);
      };
      if (_0 instanceof Types.Phil1) {
          return upgradeCostPolynomial(825000.0)(_0.value0);
      };
      if (_0 instanceof Types.Phil2) {
          return upgradeCostPolynomial(5200000.0)(_0.value0);
      };
      if (_0 instanceof Types.Poli1) {
          return upgradeCostPolynomial(6.0e7)(_0.value0);
      };
      if (_0 instanceof Types.Poli2) {
          return upgradeCostPolynomial(8.5e8)(_0.value0);
      };
      if (_0 instanceof Types.Science1) {
          return upgradeCostPolynomial(8.5e9)(_0.value0);
      };
      if (_0 instanceof Types.Science2) {
          return upgradeCostPolynomial(7.5e10)(_0.value0);
      };
  ...
  var upgradeBoost = function (_6) {
      ...
      if (_6 instanceof Types.Tech1) {
          return 40.0 * upgradeBoostModifier(_6.value0);
      };
      if (_6 instanceof Types.Tech2) {
          return 600.0 * upgradeBoostModifier(_6.value0);
      };
      if (_6 instanceof Types.Phil1) {
          return 8000.0 * upgradeBoostModifier(_6.value0);
      };
      if (_6 instanceof Types.Phil2) {
          return 122820.5 * upgradeBoostModifier(_6.value0);
      };
      if (_6 instanceof Types.Poli1) {
          return 3141592.6 * upgradeBoostModifier(_6.value0);
      };
      if (_6 instanceof Types.Poli2) {
          return 2.71828182e7 * upgradeBoostModifier(_6.value0);
      };
      if (_6 instanceof Types.Science1) {
          return 5.9e8 * upgradeBoostModifier(_6.value0);
      };
      if (_6 instanceof Types.Science2) {
          return 1.0e10 * upgradeBoostModifier(_6.value0);
      };
  ...
  var buyUpgrade = function (_7) {
      if (_7 instanceof Types.Misc1) {
          return function (_81) {
              return installUpgrade(_7)(function (__dict_Strong_0) {
                  return Lenses.burstNumber(__dict_Strong_0);
              })(0.4)(installUpgrade(_7)(function (__dict_Strong_1) {
                  return Lenses.cpsNumber(__dict_Strong_1);
              })(0.75)(recordPurchase(_7)(function (__dict_Strong_2) {
      ...
      if (_7 instanceof Types.Tech1) {
          return function (_83) {
              ...
              })(0.2)(recordPurchase(_7)(function (__dict_Strong_8) {
      ...
      if (_7 instanceof Types.Tech2) {
          return function (_84) {
              ...
              })(0.1)(recordPurchase(_7)(function (__dict_Strong_11) {
      ...
      if (_7 instanceof Types.Phil1) {
          return function (_85) {
              ...
              })(0.2)(recordPurchase(_7)(function (__dict_Strong_14) {
      ...
      if (_7 instanceof Types.Poli1) {
          return function (_87) {
              ...
              })(0.4)(recordPurchase(_7)(function (__dict_Strong_20) {
      ...
      if (_7 instanceof Types.Science1) {
          return function (_89) {
              ...
              })(0.2)(recordPurchase(_7)(function (__dict_Strong_26) {
      ...
      if (_7 instanceof Types.Science2) {
          return function (_90) {
              ...
              })(0.1)(recordPurchase(_7)(function (__dict_Strong_29) {
...
(function(exports) {
  ...
  var calculateTimeDifferential = function (delta) {
      return function (_6) {
          var clickDebt = _6 * $$Math.abs(Util.seconds(delta));
          var f = function (t) {
              if (Util.minutes(t) < 5.0) {
                  return clickDebt;
              };
              if (Util.hours(t) < 1.0) {
                  return clickDebt * 0.9;
              };
              if (Util.hours(t) < 12.0) {
              ...
              throw new Error("Failed pattern match at Save line 129, column 1 - line 130, column 1: " + [ t.constructor.name ]);
          };
          return f(delta);
      };
  };
  var getSavedState = function __do() {
      ...
      return (function () {
          ...
          return function __do() {
              Control_Monad_Eff_Console.log("currentTime: " + Prelude.show(Data_Time.showMilliseconds)(_4))();
              Control_Monad_Eff_Console.log("_now: " + Prelude.show(Data_Time.showMilliseconds)(_now))();
              Control_Monad_Eff_Console.log("sum: " + Types.prettify(Types.prettyClicks)(_cc))();
              return {
...
(function(exports) {
  ...
  var upgradeProps = function (uplens) {
      return function (state) {
          ...
          return Prelude["++"](Prelude.semigroupArray)(hoverText(state)(uplens(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))((function () {
              ...
              throw new Error("Failed pattern match at Main line 151, column 1 - line 152, column 1: " + [ _9.constructor.name ]);
          })());
      };
  };
  ...
  var render = function (state) {
      ...
      return Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.id_("body"), Util.mkClass(Prelude.show(Types.ageShow)(state.age)) ])([ Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.id_("container") ])([ top, side, main$prime, bottom ]) ]);
  };
  var $$eval = function (_8) {
          ...
          return Data_Functor["<$"](Control_Monad_Free.freeFunctor)(_8.value0)(Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.gets(function (_0) {
              ...
              return Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.gets(function (_1) {
                  ...
                  return Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query["liftEff'"](Control_Monad_Aff.monadEffAff)(Data_Date.nowEpochMilliseconds))(function (_2) {
                      var summand = Save.calculateTimeDifferential(Prelude["-"](Data_Time.ringMilliseconds)(_2)(_4))(_3);
      ...
      if (_8 instanceof Types.Reset) {
          return Data_Functor["<$"](Control_Monad_Free.freeFunctor)(_8.value0)(Halogen_Query.modify(Reset.reset));
      };
          ...
          return Data_Functor["<$"](Control_Monad_Free.freeFunctor)(_8.value1)(Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(Data_Lens_Setter.set(Lenses.message(Data_Profunctor_Strong.strongFn))("")))(function () {
              return Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query["liftAff'"](Control_Monad_Aff_Class.monadAffAff)(Control_Monad_Aff.later(Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.unit))))(function () {
                  return Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(Upgrades.buyUpgrade(_8.value0)))(function () {
                      ...
                      throw new Error("Failed pattern match at Main line 162, column 1 - line 163, column 1: " + [ _20.constructor.name ]);
                  });
              });
          }));
      };
      ...
      throw new Error("Failed pattern match at Main line 162, column 1 - line 163, column 1: " + [ _8.constructor.name ]);
  };
